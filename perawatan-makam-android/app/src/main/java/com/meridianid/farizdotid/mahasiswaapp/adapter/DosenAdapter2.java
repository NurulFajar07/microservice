...
public class DosenAdapter2 extends RecyclerView.Adapter<DosenAdapter2.DosenHolder>{

    List<SemuadosenItem2> semuadosenItemList;
    Context mContext;
    ...
    public DosenAdapter2(Context context, List<SemuadosenItem2> dosenList){
    ...
    public void onBindViewHolder(DosenHolder holder, int position) {
        final SemuadosenItem2 semuadosenitem = semuadosenItemList.get(position);
        holder.tvNamaDosen.setText(semuadosenitem.getNama());
        holder.tvNamaMatkul.setText(semuadosenitem.getMatkul());
        holder.tvNamaLokasi.setText(semuadosenitem.getId());
